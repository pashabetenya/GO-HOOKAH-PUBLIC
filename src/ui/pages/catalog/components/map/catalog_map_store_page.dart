...
class CatalogMapStorePage extends StatefulWidget {
  const CatalogMapStorePage({
    Key? key,
    required this.title,
  ...
  @override
  State<CatalogMapStorePage> createState() => _CatalogMapStorePageState();
}

class _CatalogMapStorePageState extends State<CatalogMapStorePage> {
